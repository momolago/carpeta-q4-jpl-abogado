...
5. HOLD de ingreso / envío / presentación hasta «dale» explícito (vía JACK).
...
- `Contexto-Maestro-Grok.md` (legado 4-sep) — no borrar; cifras pueden estar desactualizadas; preferir Estado de cada frente
